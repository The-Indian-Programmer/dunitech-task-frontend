...
const ListProject = () => {
  ...
  const handleAddQuestion = (row) => {
    history.push(`/admin/questions/${encode(row.id)}`)
  }
    ...
    <div className='admin-project-list'>
      <Card>
        <CardHeader>
          ...
          <Button onClick={handleClick} color='primary'>Add Project</Button>
        </CardHeader>
            ...
            {data.map((item, index) => (
              ...
              <Col sm='6' md='4' lg='4' className='' key={index}>
                <Card>
                  ...
                  <Row>
                    <Col sm='6' md='6' lg='6'>
                  <Button onClick={() => handleAddQuestion(item)} color='dark'>View Questions</Button>
                  </Col>
                    <Col sm='6' md='6' lg='6'>
